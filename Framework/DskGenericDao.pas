...
Uses
  Db, Rtti, CAtribEntity, TypInfo, SysUtils, Classes, StrUtils, IBX.IBQuery ;

type
  TDskGenericDAO = class(TComponent)
    private
      class function GetTableName<T: class>(Obj: T): String;
      class function GetValues<T: class>(Obj: T;Prop: TRttiProperty):String;
      class procedure SetValues<T: class>(Obj: T;Prop: TRttiProperty;Qry:TIBQuery;Field:String);
    public
      ...
      class procedure _get<T: class>(Qry:TIBQuery;Obj: T);
      class Procedure _geralog(acesso : string);
  end;

implementation

class function TDskGenericDAO.GetTableName<T>(Obj: T): String;
var
...
class function TDskGenericDAO.GetValues<T>(Obj: T;Prop: TRttiProperty):String;
Var
...
class procedure TDskGenericDAO.SetValues<T>(Obj: T; Prop: TRttiProperty;
  Qry: TIBQuery;Field:String);
Var
  lc_Data, Lc_Hora,Lc_Dia, Lc_Mes, Lc_Ano : String;
Begin
...
class function TDskGenericDAO._Select<T>(Obj: T; Fields:String):String;
Var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
      ...
      for Atributo in Prop.GetAttributes do begin
        ...
        Begin
          ...
          Begin
            ...
            strKeyValue := TDskGenericDAO.GetValues(Obj,Prop);
            if ( Lc_IndKey = 0 ) then
...
class function TDskGenericDAO._Insert<T>(Obj: T):String;
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Lc_Value := TDskGenericDAO.GetValues(Obj,Prop);
...
class function TDskGenericDAO._Replace<T>(Obj: T): String;
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
...
class function TDskGenericDAO._Update<T>(Obj: T):String;
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
...
class function TDskGenericDAO._Delete<T>(Obj: T):String;
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
...
class procedure TDskGenericDAO._assign<T>(Source, Dest: T);
const
...
class function TDskGenericDAO._Clear<T>(Obj: T):String;
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
...
class function TDskGenericDAO._getNextByField<T>(Obj: T; Field: String;Intitution: Integer): String;
var
  strSelect: String;
begin
  strSelect := concat(
...
class procedure TDskGenericDAO._geralog(acesso: string);
var
  Arq : TextFile;
  Data : String;
  LcArq : String;
...
class function TDskGenericDAO._getLastInsert<T>(Obj: T):String;
var
  strSelect: String;
begin
...
class procedure TDskGenericDAO._get<T>(Qry:TIBQuery;Obj: T);
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          //Monta o sql com campos preenchidos
          TDskGenericDAO.SetValues(Obj,Prop,Qry,Lc_Field);
        end;
      end;
    end;
  Except on E: Exception do
