...
Type
  ...
  public
    ...
    property VendedorExternalCode: integer read Fsalesman_external_code write setFsalesman_external_code;
...
procedure TCustomer.setFsalesman_external_code(const Value: integer);
begin
