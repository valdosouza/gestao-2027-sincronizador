...
Type
  ...
  private
    ...
    procedure setFORDERCOUNTONMERCHANT(const Value: String);
  ...
  public
    ...
    property ORDERCOUNTONMERCHANT: String read FORDERCOUNTONMERCHANT write setFORDERCOUNTONMERCHANT;
...
procedure TIfoodCustomer.setFORDERCOUNTONMERCHANT(const Value: String);
begin
