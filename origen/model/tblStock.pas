...
Type
  ...
  private
    ...
    Flink_url: String;
    Fname_color: String;
    Fname_package: String;
    Fname_measure: String;
    ...
    procedure setFname_color(const Value: String);
    procedure setFname_measure(const Value: String);
    procedure setFname_package(const Value: String);
  ...
  public
    ...
    property name_package  : String read Fname_package write setFname_package;

    [FieldName('tb_measure_id')]
     property Medida: Integer read Ftb_measure_id write setFtb_measure_id;

     property name_measure : String read Fname_measure write setFname_measure;

    [FieldName('tb_color_id')]
     property Cor: Integer read Ftb_color_id write setFtb_color_id;

    property name_color : String read Fname_color write setFname_color;
...
procedure TStock.setFname_color(const Value: String);
begin
  Fname_color := Value;
end;

procedure TStock.setFname_measure(const Value: String);
begin
  Fname_measure := Value;
end;

procedure TStock.setFname_package(const Value: String);
begin
  Fname_package := Value;
end;
