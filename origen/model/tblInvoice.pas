...
Type
  ...
  private
    ...
    Fdoc_issuer: String;
    Fissuer_external_code: Integer;
    Fentity_external_code: Integer;
    ...
    procedure setFkind_emis(const Value: String);
    ...
    procedure setFentity_external_code(const Value: Integer);
    procedure setFissuer_external_code(const Value: Integer);
  ...
  public
    ...
    property IssuerExternalCode: Integer read Fissuer_external_code write setFissuer_external_code;

    [FieldName('kind_emis')]
    property TipoEmissao: String read Fkind_emis write setFkind_emis;
    ...
    property EntityExternalCode: Integer read Fentity_external_code write setFentity_external_code;
...
procedure Tinvoice.setFentity_external_code(const Value: Integer);
begin
...
procedure Tinvoice.setFissuer_external_code(const Value: Integer);
begin
  Fissuer_external_code := Value;
end;

procedure Tinvoice.setFkind_emis(const Value: String);
begin
  Fkind_emis := Value;
end;
