...
Type
  ...
  TAnunciante = Class(TGenericEntity)
  private
    FEMP_ATIVO: String;
    FEMP_CODIGO: Integer;
    FEMP_CADASTRO: Tdate;
...
procedure TAnunciante.setFEMP_ATIVO(const Value: String);
begin
  FEMP_ATIVO := Value;
end;

procedure TAnunciante.setFEMP_CADASTRO(const Value: Tdate);
begin
  FEMP_CADASTRO := Value;
end;

procedure TAnunciante.setFEMP_CODIGO(const Value: Integer);
begin
  FEMP_CODIGO := Value;
end;
