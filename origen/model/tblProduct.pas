...
Type
  ...
  private
    ...
    procedure setFname_category(const Value: String);
  ...
  public
    ...
    property name_category : String read Fname_category write setFname_category;
...
procedure TProduct.setFname_category(const Value: String);
begin
  Fname_category := Value;
end;
