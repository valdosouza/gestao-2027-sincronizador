...
Type
  ...
  private
    ...
    procedure setFname_brand(const Value: String);
  ...
  public
    ...
    property name_brand  : String read Fname_brand write setFname_brand;
...
procedure TMerchandise.setFname_brand(const Value: String);
begin
  Fname_brand := Value;
end;
