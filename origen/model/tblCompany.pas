...
Type
  ...
  private
    ...
    procedure setFcrt_modal(const Value: String);
  ...
  public
    ...
    [FieldName('crt_modal')]
    property CRTmodal: String read Fcrt_modal write setFcrt_modal;
...
procedure TCompany.setFcrt_modal(const Value: String);
begin
  Fcrt_modal := Value;
end;
