...
uses IBX.IBDatabase, Classes, SysUtils, ControllerBase, tblRetaguardaSync,
     Generics.Collections, IBX.IBQuery,ControllerSincronia,
...
Type
  ...
  private
    ...
    FBancoRetaguarda: TIBDatabase;
    FBancoPDV: TIBDatabase;
    ...
    procedure setFBancoRetaguarda(const Value: TIBDatabase);
    procedure setFBancoPDV(const Value: TIBDatabase);
  ...
  public
    ...
    property BancoRetaguarda : TIBDatabase read FBancoRetaguarda write setFBancoRetaguarda;
    property BancoPDV : TIBDatabase read FBancoPDV write setFBancoPDV;
  End;
...
procedure TControllerRetaguardaSync.setFBancoPDV(const Value: TIBDatabase);
begin
  FBancoPDV := Value;
end;
