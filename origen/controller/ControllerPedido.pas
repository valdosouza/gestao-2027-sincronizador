...
uses  IBDatabase,Classes, IBQuery, SysUtils,ControllerBase,
      ...
      ControllerFormaPagamento,ControllerCtrlEstoque, AnsiStrings;
      ...
      Begin
        ...
        Begin
          MensagemPadrao('Mensagem', 'A T E N � � O!.' + EOLN + EOLN +
                         'Este pedido j� foi Faturado.' + EOLN +
                         '    Opera��o cancelada.'+EOLN,
...
Var
  ...
  Lc_Numero : Integer;
Begin
  //Faturado ou Excluido n�o ser�o alterados no sistema
  Result := False;
  if ( Registro.CodigoWeb > 0 ) then
  Begin
    Lc_Qry := GeraQuery;
...
procedure TControllerPedido.getListSincronia;
var
  Lc_Qry : TIBQuery;
  LITem : TPedido;
begin
    ...
    Try
      ...
      Begin
        ...
        Begin
          ...
          Begin
            MensagemPadrao('Mensagem', 'A T E N � � O!.' + EOLN + EOLN +
                           'H� uma inconsist�ncia no faturamento deste pedido.' + EOLN +
                           ' Ele consta como faturado, v� em Nota Fiscal de Produtos '+EOLN+
...
begin
  ...
  Begin
    ...
    BEGIN
      MensagemPadrao('MENSAGEM DE ERRO','A T E N � � O!.'+EOLN+EOLN+
                     'O Valor do Pedido n�o confere com Valor do Parcelamento.'+EOLN+
                     'Refa�a o parcelamento.'+EOLN,
                     ['OK'],[BESCAPE],MPERRO);
      Result := FALSE;
    end;
  End;
