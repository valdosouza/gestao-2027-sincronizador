...
begin
  ...
  try
    ...
    Begin
      ...
      ParamByName('ITF_SENTIDO').AsAnsiString := AnsiString(Registro.Sentido);
...
Begin
  ...
  Try
    ...
    Begin
      ...
      ParamByName('ITF_OPER').AsAnsiString := AnsiString(Pc_Tp_Operacao);
...
Begin
  Result := True;
  //Fiz errado no controle errado tendo uma fun��o para isso no controller pedido  - analiando se vale a pena manter
  Lc_Qry := GeraQuery;
  Try
