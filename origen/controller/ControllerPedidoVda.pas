...
uses ControllerPedido,ControllerCliente, System.Classes,
    ...
    ObjCustomer, IBX.IBQuery,ControllerBase;
...
begin
  ...
  // TObjCustomer (destiny/data_objetcs) não tem Estabelecimento no nível raiz
  // — vive em Fiscal.Entidade. fillDataObjeto é parameterless (opera nos
  // campos de instância Registro/Obj do próprio Cliente, não em parâmetros).
  Cliente.Obj.Fiscal.Entidade.Estabelecimento := Obj.Estabelecimento;
  Cliente.fillDataObjeto;
  ...
  Obj.Totalizer.Al�quotaDesconto  := PcRegistro.AliqDesconto;
...
begin
  ...
  Begin
    ...
    //caso n�o venha com CPF nem CNPJ vamos criar uma empresa para poder receber o pedido e o cliente alterar depois
    ...
    Registro.AliqDesconto          := porder.Totalizer.Al�quotaDesconto;
