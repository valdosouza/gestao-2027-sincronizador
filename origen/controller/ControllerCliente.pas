...
begin
  ...
  // VendedorExternalCode removido: tb_customer.destiny/model/tblCustomer.pas
  // não tem mais essa propriedade (Integer disfarçado de "external code" —
  // exatamente o problema resolvido pelo motor de reindexação por documento
  // em customer_send_web.pas, que já resolve o vendedor via
  // DM.GetDocumentByEmpCodigo e não depende mais deste método legado).
