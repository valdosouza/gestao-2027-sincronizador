...
uses ControllerBase, tblRetaguardaSync, IBX.IBQuery, IBX.IBDatabase,
...
Type
  ...
  private
    ...
    FDataFinal: TDate;
    FDataInicial: TDate;
    function getFBancoRetaguarda: TIBDatabase;
  ...
  public
    ...
    property BancoRetaguarda : TIBDatabase read getFBancoRetaguarda;
...
function TControllerretaguardawebSync.getFBancoRetaguarda: TIBDatabase;
begin
...
procedure TControllerretaguardawebSync.setFBancoPDV(const Value: TIBDatabase);
begin
  FBancoPDV := Value;
end;
