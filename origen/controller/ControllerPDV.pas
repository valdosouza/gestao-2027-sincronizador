...
uses IBX.IBDatabase,Classes,  SysUtils,ControllerBase,
      Generics.Collections, IBX.IBQuery,ControllerTrigger;
...
procedure TControllerPDV.execSQL(Qry: TIBQuery);
begin
  with Qry do
  Begin
    try
...
procedure TControllerPDV.setFBancoPDV(const Value: TIBDatabase);
begin
  FBancoPDV := Value;
end;
