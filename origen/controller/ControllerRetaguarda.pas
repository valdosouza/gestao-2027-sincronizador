...
interface
uses IBX.IBDatabase,Classes,  SysUtils,ControllerBase,tblRetaguarda ,
...
procedure TControllerRetaguarda.execSQL(Qry: TIBQuery);
begin
  with Qry do
  Begin
    try
...
procedure TControllerRetaguarda.setFBancoPDV(const Value: TIBDatabase);
begin
  FBancoPDV := Value;
end;
