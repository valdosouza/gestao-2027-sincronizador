...
begin
  ...
  BEgin
    ...
    //EntityExternalCode
    EntityExternalCode.Codigo          := 0; //Sempre zero pois será redefnido no Sistema Web
    ...
    Begin
      Fisica.Codigo := 0; //Sempre zero pois será redefnido no Sistema Web
    ...
    Begin
      Juridica.Codigo := 0; //Sempre zero pois será redefnido no Sistema Web
  ...
  BEgin
    ...
    Codigo          := 0; //Sempre zero pois será redefnido no Sistema Web
