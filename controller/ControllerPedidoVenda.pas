...
begin
  ...
  Obj.OrderSale.CustomerExternalCode := PcReg.Empresa;
  obj.OrderSale.SalesmanExternalCode := PcReg.Vendedor;
  ...
  Obj.Billing.name_payment    := FormaPagto.Registro.Descricao;
...
begin
  ...
  Registro.Vendedor               := pOrder.OrderSale.SalesmanExternalCode;
  ...
  Begin
    ...
    FormaPagto.Registro.Descricao := pOrder.Billing.name_payment;
