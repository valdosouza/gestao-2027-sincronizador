...
begin
  ...
  Begin
    ...
    //Trata quem é o emitente da nota
    Nota.Emitente           := 0;
    if (PcRegistro.Tipo = 'EE') OR (PcRegistro.Tipo = 'EM') then
      Nota.IssuerExternalCode := PcRegistro.CodigoEmpresa
    else
      Nota.IssuerExternalCode := 0;
    //Trata quem é o destinatario da Nota
    Nota.Destinatario       := 0;
    Nota.EntityExternalCode := PcRegistro.CodigoEmpresa;
...
begin
  ...
  Begin
    ...
    Begin
      ...
      LcIcms.DeterminacaoBase    := Pedido.Itens.ItensIcms.Lista[I].Determinacao;
      LcIcms.DeterminacaoBaseST  := Pedido.Itens.ItensIcms.Lista[I].DeterminacaoBaseST;
...
begin
  ...
  Begin
    ...
    Begin
      ...
      LcIPI.Base                  := Pedido.Itens.ItensIPI.Lista[I].ValorBase;
      LcIPI.Aliquota              := Pedido.Itens.ItensIPI.Lista[I].Aliquota;
      LcIPI.QuantUnidade          := Pedido.Itens.ItensIPI.Lista[I].QtdeUnid;
      LcIPI.Valor                 := Pedido.Itens.ItensIPI.Lista[I].ValorUnid;
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      LcPis.Base                  := Pedido.Itens.ItensPis.Lista[I].ValorBase;
