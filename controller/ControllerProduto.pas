     ...
     //Objeto Mercadoria
      ...
      BEgin
        ...
        if LcOriMarca.exist then
          name_brand := LcOriMarca.Registro.Descricao
        else
          name_brand := 'NÃO INFORMADA';
      ...
      BEgin
        ...
        if LcOriEmbalagem.exist then
          name_package := LcOriEmbalagem.Registro.Descricao
        else
          name_package := 'UND';
        Medida            := 0;
        ...
        if LcOriMedida.exist then
          name_measure := LcOriMedida.Registro.Descricao
        else
          name_measure := 'UND';
        Cor               := 0;
        name_color        := '';
...
begin
  ...
  Begin
    ...
    Marca.Registro.Descricao := DObj.Mercadoria.name_brand;
    Marca.getIdAutoByDesc;
    CodigoMarca          := Marca.Registro.Codigo;

    Medida.Registro.Descricao := DObj.Estoque.name_measure;
    Medida.getIdAutoByDesc;
    MedidaComercial          := Medida.Registro.Codigo;

    Embalagem.Registro.Descricao := DObj.Estoque.name_package;
    Embalagem.getIdAutoByDesc;
    CodigoEmbalagem       :=  Embalagem.Registro.Codigo;

    CodigoGrupo           :=  Grupo.autocreate(DObj.Produto.name_category);
    CodigoSubgrupo        :=  Grupo.SubGRupo.autocreate(CodigoGrupo,DObj.Produto.name_category);
