...
uses
  ...
  Vcl.ExtCtrls, Vcl.Menus, Vcl.StdCtrls, IBX.IBQuery,Un_DM;
...
type
  ...
  protected
    ...
    procedure SetParameters(Param: TIBQuery);Virtual;
...
procedure TBaseSearch.SetParameters(Param: TIBQuery);
begin
