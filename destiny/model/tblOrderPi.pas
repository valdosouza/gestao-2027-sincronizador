...
Type
  ...
  private
    ...
    procedure setFpadv_number(const Value: String);
  ...
  public
    ...
    property PADVNumber: String read Fpadv_number write setFpadv_number;
...
procedure TOrderPi.setFpadv_number(const Value: String);
begin
  Fpadv_number := Value;
end;
