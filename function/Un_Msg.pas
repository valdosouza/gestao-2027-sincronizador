...
//classe do fomulario se ser usado
type TFormMsg = class(TForm)
...
procedure TFormMsg.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;
...
begin
  ...
  Try
    ...
    with Formulario do
      ...
      KeyPreview := True;
      //Muda o estilo da fonte para bold, apenas para realizar os c�lculos
      Font.Style := [fsBold];
      Color      := Lc_Cor;
      Font.Color := clBlack;
      case Color of
    ...
    {Escreve a mensagem no formul�rio}
