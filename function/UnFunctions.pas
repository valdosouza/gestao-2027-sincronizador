...
interface
  uses zLib, System.Classes, Vcl.Forms, Winapi.Windows;
...
uses  REST.Json, un_sistema, System.SysUtils, System.DateUtils;
...
{-----------------------------
 Fun��o : StrTran
 Descri��o : Procura pelas ocorrencias de um caracter numa
...
Begin
  ...
  begin
    ...
    begin
      Result := 'N�mero de C.P.F. Inv�lido.';
      exit;
    end;
  end
  else
  begin
    ...
    begin
      Result := 'N�mero de C.N.P.J. Inv�lido.';
      exit;
    end;
  end;
End;
